...
const PrintBarangayClearancePage: React.FC = () => {
  ...
  const fetchCertificateData = async (id: string) => {
    try {
      const response = await fetch(`/api/certificates/requests/${id}/print-barangay-clearance/`);
      if (response.ok) {
        await response.text();
        setCertificateData({
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white p-8 shadow-lg print:shadow-none">
          ...
          <div className="text-center my-8">
            ...
            <p className="text-lg text-gray-600 mt-2">Certificate of Good Moral Character</p>
          </div>
          ...
          <div className="text-justify leading-relaxed">
            ...
            <p className="text-gray-800 mb-4">
              That this certification is being issued upon the request of the interested party for the purpose of:
            </p>
            <p className="text-gray-800 mb-4 font-medium">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8">
            <div className="text-center">
              <p className="text-gray-800 mb-8">Prepared by:</p>
              <p className="text-gray-600 text-sm">_________________________</p>
              <p className="text-gray-600 text-sm mt-1">Barangay Secretary</p>
            </div>
            <div className="text-center">
              <p className="text-gray-800 mb-8">Approved by:</p>
              <p className="text-gray-600 text-sm">_________________________</p>
              <p className="text-gray-600 text-sm mt-1">HON. BARANGAY CAPTAIN</p>
            </div>
          </div>
...
export default PrintBarangayClearancePage;
