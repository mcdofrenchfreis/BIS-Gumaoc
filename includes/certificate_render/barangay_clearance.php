...
$certificate_number = 'BC-' . str_pad((string) $request_id, 5, '0', STR_PAD_LEFT) . '-' . date('Y');
...
clp_html_head('BARANGAY CLEARANCE - ' . $certificate_data['full_name']);
clp_print_controls('view-certificate-requests.php', $meta, $embed);
clp_open_page();
clp_header();
clp_doc_title('BARANGAY CLEARANCE');
clp_open_body();
?>
            <div class="cert-row-photo">
                <div class="cert-col-text">
                    <div class="cert-salutation">TO WHOM IT MAY CONCERN,</div>
                    <p class="cert-p">This is to certify that the person whose name, signature, thumb marks,
                    ...
                    <p class="cert-p cert-p--after-details">This is to certify that he/she is a bonafide resident of this Barangay. He/She is known to
                        me with a good moral character, law-abiding citizen in the community. He/She has no
